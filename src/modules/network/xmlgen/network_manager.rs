...
trait NetworkManager {
    ...
    fn check_connectivity(&self) -> zbus::Result<NMConnectivityState>;
    ...
    fn checkpoint_rollback(
        &self,
        checkpoint: &zbus::zvariant::ObjectPath<'_>,
    ) -> zbus::Result<std::collections::HashMap<String, NMRollbackResult>>;
    ...
    #[zbus(property)]
    fn capabilities(&self) -> zbus::Result<NMCapabilityVec>;
